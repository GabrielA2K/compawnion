                    ...
                    <div class="card-stationary post" id="post_<?php echo $id ?>">
                        ...
                        <?php
                            ...
                            while($row = $qry->fetch(PDO::FETCH_ASSOC)){
                                array_push($reportGet, $row);
                            }


                        ?>
                        <div class="circle">
                            <?php echo sizeof($reportGet); ?>
                        </div>
                        <div class="post-container">
                            <div class="post__content-holder">
                                ...
                                <div class="var-info-container">
                                    ...
                                    <div class="var-value">
                                        <em class="var-value"><?php echo $fullname; ?></em>
                                    </div>
                                </div>
                                <div class="var-info-container">
                                    <div class="var-name">
                                    ...
                                    <div class="var-value">
                                        <em class="var-value"><?php echo $username; ?></em>
                                    </div>
                                </div>
                                <div class="post__info-holder">
                                    ...
                                    <h3 class="post__info-content red reporter">
                                        <?php
                                            $qry = $pdo->query("SELECT reportedBy FROM reported_posts_tb where postID = ".$id);
                                            $reportedBys = array();
                                            while($row = $qry->fetch(PDO::FETCH_ASSOC)){
        ...
        <div class="adopt-modal">
            <div class="modal-card">
                ...
                <div class="modal-content-container">
                                    ...
                                    <h3 class="pet__info">
                                        <br>Classification: <em><?php echo $post[$i]["petClass"]; ?></em>
                                    </h3>
                                    <h3 class="pet__info">
                                        Breed: <em><?php echo $post[$i]["petBreed"]; ?></em>
                                    </h3>
                                    <h3 class="pet__info">
                                        Sex: <em><?php echo $post[$i]["petSex"]; ?></em>
                                    </h3>
                                    <h3 class="pet__info">
                                        Age: <em><?php echo $post[$i]["petAge"]; ?></em>
                                    </h3>
                                    <h3 class="post__info-title">
                                        Other Descriptions:
                                    </h3>
                                    <h3 class="post__info-content">
                                        <?php echo $post[$i]["petDesc"]; ?>
                                    </h3>
                                    <h3 class="post__info-title">
                                        Reason for rehoming:
                                    </h3>
                                    <h3 class="post__info-content">
                                        <?php echo $post[$i]["reason"]; ?>
                                    </h3>
                </div>
