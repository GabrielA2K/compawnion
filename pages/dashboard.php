...
-->
            ...
            <?php
                if($_SESSION['accountType'] == "admin"){ ?>
                    <h2 class="section__name">Admin Controls</h2>
                    <div class="section__notification">
                        <a href="accounts.php">
                        <div class="notification card">
                            <h3 class="card__title">Manage Accounts</h3>
                            <p class="card__subtitle">Manage registered users</p>
                        </div>
                        </a>
                    </div>
                    ...
                    <div class="section__notification">
                        ...
                        <div class="notification card">
                            <h3 class="card__title">Add Admin Account</h3>
                            <p class="card__subtitle">Add another admin account</p>
                        </div>
                        </a>
                    </div>
            ...
            <a href="reported-posts.php">
            <div class="shortcut card">
            <h3 class="card__title">Reported Posts</h3>
            <p class="card__subtitle">View reported posts</p>
            </div>
            </a>
            <?php
